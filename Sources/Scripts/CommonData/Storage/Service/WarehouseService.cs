...
namespace Sources.Scripts.CommonData.Storage.Service
{
    public class WarehouseService : StorageService
    {
        ...
        public static bool IsEnoughRequiredProducts(WarehouseBoxData warehouseBoxData,
            NativeList<ProductData> requiredData)
        {
            bool first = warehouseBoxData.Value[(int)requiredData[0].Name] >= requiredData[0].Quantity;
            ...
            return requiredData.Length switch
            {
                ...
                1 => first,
                2 => first && warehouseBoxData.Value[(int)requiredData[1].Name] >= requiredData[1].Quantity,
                _ => false
            };
        }

        public static NativeList<ProductData> GetProductsForProductionAndMaxLoads(WarehouseBoxData warehouseBoxData,
            ...
            int loadCapacity, out int maxLoads)
        {
            ...
            maxLoads = GetMaxLoads(warehouseBoxData.Value, tempLoadsCount, requiredQuantity);
