...
namespace Sources.Scripts.CommonData.Storage.Service
{
    public abstract class StorageService
    {
        ...
        /// <summary>
        /// Reduce products quantity in <see cref="MainStorageBoxData"/> by key-value from list of <see cref="ProductData"/>
        ...
        /// <summary>
        /// Increase products quantity in <see cref="MainStorageBoxData"/> by key-value from list of <see cref="ProductData"/>
        /// <param name="productsData">list of <see cref="ProductData"/></param>
        /// </summary>
        ...
        /// <summary>
        /// Get sum of products quantity in <see cref="MainStorageBoxData"/> by key-value from list of <see cref="ProductData"/>
        /// <param name="productsData">list of <see cref="ProductData"/></param>
